# Newsfeed-Components (USED SASS INSTEAD OF LESS)
...
- Run `less-watch-compiler less css index.less` from the top level of the Newsfeed-Components folder. (USED SASS INSTEAD!!!)
- Open index.html in your browser

### Part 1: The Menu

- Import `Menu.less` from the correct path into index.less (follow the example for `Header.less` if you’re not sure how to write the correct path) (USED SASS INSTEAD!!!)
...
- Import `Article.less` from the correct path into index.less (follow the example for `Header.less` if you’re not sure how to write the correct path) (USED SASS INSTEAD!!!)
...
- jQuery
  ...
  - http://www.jquery.com
- GSAP (I USED GSAP - TWEENMAX FOR THIS ASSIGNMENT)
